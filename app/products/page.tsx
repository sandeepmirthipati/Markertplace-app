                    ...
                    <Link key={product.id} href={`/products/${product.id}`}>
                      <div className="bg-card rounded-lg overflow-hidden border border-border hover:border-accent/50 transition-all hover:shadow-lg group cursor-pointer h-full flex flex-col">
                        <div className="relative h-64 bg-muted overflow-hidden">
                          <img
                            src={`/ceholder-svg-key-lbpja-height-256-width-256-text-.jpg?key=lbpja&height=256&width=256&text=${encodeURIComponent(product.name)}`}
                            alt={product.name}
                            ...
                            onError={(e) => {
                              e.currentTarget.src = `/placeholder.svg?height=256&width=256&text=${encodeURIComponent(product.brand)}`
                            }}
                          />
